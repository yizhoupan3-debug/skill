...
def test_routing_eval_baseline_is_actionable() -> None:
    ...
    assert results_by_id["skill-developer-codex-generic-review-case"]["selected_owner"] == "skill-developer-codex"
    assert results_by_id["skill-developer-codex-generic-review-case"]["selected_overlay"] == "code-review"
