...
pub fn seed_framework_markers(root: &Path) {
    write_text(
        ...
        r#"{"schema_version":"framework-runtime-registry-v1","framework_core":{"authority":"rust","source":"framework-root-native","host_policy":"closed-set-explicit-projections"},"host_targets":{"policy":"shared-rust-core-explicit-host-projections","supported":["codex-cli","codex-app","cursor","claude-code"],"shared_system_source":"skills","metadata":{"codex-cli":{"install_tool":"codex","host_entrypoints":"AGENTS.md"},"codex-app":{"install_tool":"codex","host_entrypoints":"AGENTS.md"},"cursor":{"install_tool":"cursor","host_entrypoints":["AGENTS.md",".cursor/rules/*.mdc"]},"claude-code":{"install_tool":"claude","host_entrypoints":["AGENTS.md",".claude/rules/framework.md"]}}},"host_projections":{"codex-cli":{"profile_id":"codex_profile","host_id":"codex-cli","transport":"native-codex","capabilities":["external_session_supervisor"],"session_supervisor_driver":"codex_driver","session_supervisor_status":{"supported":true}},"cursor":{"profile_id":"cursor_profile","host_id":"cursor","transport":"cursor-agent","capabilities":[],"session_supervisor_driver":"unsupported","session_supervisor_status":{"supported":false}},"claude-code":{"profile_id":"claude_profile","host_id":"claude-code","transport":"anthropic-claude-code","capabilities":[],"session_supervisor_driver":"unsupported","session_supervisor_status":{"supported":false}}}}"#,
    );
    write_text(
