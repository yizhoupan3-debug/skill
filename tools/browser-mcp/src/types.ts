...
export interface BrowserRuntimeOptions {
  ...
  /** Optional path to any persisted Rust attach artifact; descriptors, handoffs, resume manifests, and transport bindings are hydrated internally. */
  runtimeAttachArtifactPath: string | null;
