...
pub(crate) fn cursor_hook_event_is_subtracted(lowered_event: &str) -> bool {
    matches!(
        lowered_event,
        "afteragentresponse"
            | "beforeshellexecution"
...
pub(crate) fn cursor_hooks_json_registers_event(repo_root: &Path, lowered_event: &str) -> bool {
...
pub(crate) fn should_noop_subtracted_event(repo_root: &Path, lowered_event: &str) -> bool {
...
pub(crate) fn subtracted_event_noop_output(lowered_event: &str) -> Value {
    match lowered_event {
