...
L3 行为因宿主而异，详见各宿主手册（[Cursor](hosts/cursor.md) · [Codex](hosts/codex.md)）。以下为 Cursor 实现摘要：
...
Do not share one lock file between Cursor and Codex. See [`task_write_lock.rs`](../core/antigravity/src/utils/task_write_lock.rs) and [`hosts/codex_hooks/mod.rs`](../core/router-rs/src/hosts/codex_hooks/mod.rs).
...
- [`core/antigravity/src/utils/task_write_lock.rs`](../core/antigravity/src/utils/task_write_lock.rs) (L1 contract; `router-rs` re-exports via `core_state`)
