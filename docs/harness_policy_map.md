...
| 五层模型、证据流、续跑/门控、`ROUTER_RS_*` 语义与默认值 | [`harness_architecture.md`](harness_architecture.md)（尤其 **§5 开关面**） | [`router_env_flags.rs`](../core/router-rs/src/router_env_flags.rs) 仅提供 **helper 子集** + 注释索引；散落 `std::env::var` 仍以 harness §5 为准 |
