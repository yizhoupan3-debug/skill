...
Independent reviewer evidence when parsed as logical **`false`** only (`cursor_review_independent_fork` / `fork_context_from_values` in [`review/engine.rs`](../../core/router-rs/src/review/engine.rs)):
