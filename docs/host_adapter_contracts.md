...
叙事的中心。
`framework_runtime.host_adapter_compatibility.build_upgrade_compatibility_matrix(...)`
也只允许停留在 secondary
...
- `framework_runtime.host_adapters.compile_codex_common_adapter(...)`
- `framework_runtime.host_adapter_compatibility.compile_aionrs_companion_adapter(...)`
- `framework_runtime.host_adapter_compatibility.compile_aionui_host_adapter(...)`
...
- `framework_runtime.host_adapter_compatibility.build_codex_desktop_alias_retirement_status(...)`
...
同样，legacy / compatibility compiler 入口不再作为根包 `framework_runtime`
