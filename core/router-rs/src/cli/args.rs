...
pub(crate) enum RouterCommand {
    ...
    /// Unified host commands: codex, cursor, claude, claude-desktop
    Host {
        #[command(subcommand)]
        command: HostCommand,
    },
    ...
    ClaudeDesktop {
        #[command(subcommand)]
        command: ClaudeDesktopSubcommand,
    },
    Trace {
        #[command(subcommand)]
...
/// Unified host commands (merged: codex, cursor, claude, claude-desktop)
#[derive(Subcommand, Debug, Clone)]
pub(crate) enum HostCommand {
    ...
    AntigravityCli {
        #[command(subcommand)]
        command: AntigravityCliSubcommand,
    },
    #[command(name = "antigravity-app")]
    AntigravityAppHost {
        #[command(subcommand)]
...
#[derive(Subcommand, Debug, Clone)]
pub(crate) enum AntigravityCliSubcommand {
    Hook(AntigravityCliHookCommand),
    InstallHooks(AntigravityCliInstallHooksCommand),
}
...
#[derive(Args, Debug, Clone)]
pub(crate) struct AntigravityCliHookCommand {
...
#[derive(Args, Debug, Clone)]
pub(crate) struct AntigravityCliInstallHooksCommand {
    #[arg(long)]
    pub(crate) antigravity_cli_home: Option<PathBuf>,
    #[arg(long)]
    pub(crate) repo_root: Option<PathBuf>,
    #[arg(long)]
...
#[derive(Args, Debug, Clone)]
pub(crate) struct ClaudeDesktopAgentCommand {
    #[arg(long)]
    pub(crate) repo_root: Option<PathBuf>,
}
