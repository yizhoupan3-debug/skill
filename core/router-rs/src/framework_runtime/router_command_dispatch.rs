...
pub(crate) fn dispatch_framework_command(command: FrameworkCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_framework_skills(command: SkillsSubcommand) -> Result<(), String> {
...
pub(crate) fn dispatch_host_command(command: HostCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_diagnose_command(command: DiagnoseCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_codex_command(command: CodexSubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_cursor_command(command: CursorSubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_claude_command(command: ClaudeSubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_antigravity_command(command: AntigravitySubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_opencode_command(command: OpenCodeSubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_trace_command(command: TraceCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_storage_command(command: StorageCommand) -> Result<(), String> {
    match command {
...
#[cfg(feature = "codegraph")]
pub(crate) fn dispatch_codegraph_command(command: CodegraphSubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_browser_command(command: BrowserSubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_profile_command(command: ProfileSubcommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_migrate_command(command: MigrateCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_hook_policy_command(command: HookPolicyCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_closeout_command(command: CloseoutCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_eval_command(command: EvalCommand) -> Result<(), String> {
    match command {
...
pub(crate) fn dispatch_schema_drift_command(command: SchemaDriftCommand) -> Result<(), String> {
