...
pub(crate) fn build_trace_transport_payload(
    payload: &Value,
    session_id: String,
...
pub(crate) fn build_trace_transport_descriptor(payload: Value) -> Result<Value, String> {
...
pub(crate) fn build_trace_handoff_descriptor(payload: Value) -> Result<Value, String> {
...
pub(crate) fn build_checkpoint_resume_manifest(payload: Value) -> Result<Value, String> {
    let session_id =
