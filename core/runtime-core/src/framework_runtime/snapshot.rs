...
use super::json_value::{nonempty_string, value_text};
use super::runtime_view;
use serde_json::{Value, json};
use std::path::Path;
use tracing::instrument;

use super::util::{count_evidence_rows, truncate_utf8_chars};
...
pub fn build_framework_runtime_snapshot_envelope_with_level(
    ...
    let mut runtime_snapshot = json!({
        "ok": true,
        "workspace": runtime_view::workspace_name_from_root(repo_root),
