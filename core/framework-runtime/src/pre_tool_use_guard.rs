...
use framework_core::tool_safety_rules;
use framework_core::runtime_registry::load_runtime_registry_json;
...
pub fn evaluate_pre_tool_use_guard(
    ...
    let repo_root = request
        ...
        .map(|p| framework_core::repo_roots::resolve_repo_root_arg(Some(p)))
        .transpose()?
        .unwrap_or_else(|| {
