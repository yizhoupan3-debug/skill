...
pub fn is_review_prompt(text: &str) -> bool {
    ...
    let tokens = crate::tokenize_query(&sanitized);
...
pub(crate) fn install_review_prompt_test_deps() {
    ...
    impl crate::TokenizerProvider for WhitespaceTokenizer {
    ...
    crate::install_tokenizer_provider(Box::new(WhitespaceTokenizer));
