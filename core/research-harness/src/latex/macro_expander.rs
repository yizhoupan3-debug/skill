...
use crate::latex::functions::FUNCTIONS;
use crate::latex::parse_node::Mode;
    ...
    fn load_function_macros(&mut self) {
        ...
        self.macros.set(
            ...
            MacroDefinition::Function(|me: &mut MacroExpander| -> ParseResult<Vec<Token>> {
                ...
                let s = crate::latex::mhchem::mhchem_arg_tokens_to_string(&args[0]);
                let tex = crate::latex::mhchem::chem_parse_str(&s, "ce")
        ...
        self.macros.set(
            ...
            MacroDefinition::Function(|me: &mut MacroExpander| -> ParseResult<Vec<Token>> {
                let args = me.consume_args(1)?;
                let s = crate::latex::mhchem::mhchem_arg_tokens_to_string(&args[0]);
                let tex = crate::latex::mhchem::chem_parse_str(&s, "pu")
