...
pub(super) const TRACE_COMPACTION_RESULT_SCHEMA_VERSION: &str =
    "runtime-trace-compaction-result-v1";
...
pub(super) const TRACE_COMPACTION_SNAPSHOT_SCHEMA_VERSION: &str =
    "runtime-trace-compaction-snapshot-v1";
pub(super) const TRACE_COMPACTION_DELTA_SCHEMA_VERSION: &str = "runtime-trace-compaction-delta-v1";
pub(super) const TRACE_COMPACTION_ARTIFACT_REF_SCHEMA_VERSION: &str =
    "runtime-trace-artifact-ref-v1";
pub(super) const TRACE_COMPACTION_MANIFEST_SCHEMA_VERSION: &str =
    "runtime-trace-compaction-manifest-v1";
