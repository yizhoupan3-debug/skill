...
- 维护入口：`./scripts/router-rs/run_router_rs.sh ./scripts/router-rs/Cargo.toml codex host-integration run-memory-automation --repo-root <repo_root> --workspace <workspace>`。
