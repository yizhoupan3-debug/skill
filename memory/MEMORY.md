...
- 非 trivial 会话必须记录 checkpoint，并在结束时执行 `./scripts/router-rs/target/release/router-rs --claude-hook-command session-end --repo-root <repo_root> --claude-hook-max-lines 4`；兼容别名 `end-session`
