...
- 非 trivial 会话必须记录 checkpoint，并在结束时执行 `python3 scripts/router_rs_runner.py --claude-hook-command session-end --repo-root <repo_root> --claude-hook-max-lines 4`；兼容别名 `end-session`
