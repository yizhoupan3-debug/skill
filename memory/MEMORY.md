...
- **核心关注**: skill 路由系统、执行编排、Hermes 增强层、三 CLI 治理、长期记忆与自动化
...
- 非 trivial 会话必须记录 checkpoint，并在结束时执行 `session_lifecycle_hook.py end-session`
- Hermes 只 propose，Codex runtime 验证并 apply
