"""Configuration for the shared framework runtime."""
...
_DEFAULT_RUNTIME_ROOT_DIRNAME = "framework_runtime"
...
class RuntimeSettings(BaseSettings):
    ...
    def resolved_data_dir(self) -> Path:
        ...
        """
        return (self.codex_home / _DEFAULT_RUNTIME_ROOT_DIRNAME / self.data_dir).resolve()
    ...
    def resolved_memory_dir(self) -> Path:
        ...
        """
        return (self.codex_home / _DEFAULT_RUNTIME_ROOT_DIRNAME / "data" / "memory").resolve()
    ...
    def resolved_db_file(self) -> Path:
        ...
        """
        return (self.codex_home / _DEFAULT_RUNTIME_ROOT_DIRNAME / self.db_file).resolve()
