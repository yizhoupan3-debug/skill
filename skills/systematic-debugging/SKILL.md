...
- In this repository, use [`RTK.md`](${SKILL_FRAMEWORK_ROOT}/RTK.md) only when the command is high-volume and compact output still preserves the needed evidence; prefer raw output when the exact failing line matters.
