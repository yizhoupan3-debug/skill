...
- **Dual-Dimension Audit (Pre: Plan/Syntax, Post: Dataset-Result/Performance)** → runtime verification gate
...
- **Superior Quality Audit**: For production or complex analytical SQL, apply the runtime verification gate to verify against [Superior Quality Bar](runtime verification criteria).
...
- "Use the runtime verification gate to audit this SQL query for execution-plan idealism."
