...
| `slides` | L3 | gate | artifact | Create, edit, verify, and export editable `.pptx` slide decks. Use this artifact |
...
| `ppt-pptx` | L4 | owner | none | Create polished editable `.pptx` decks with PptxGenJS, theme-driven styling, loc |
