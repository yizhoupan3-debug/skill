...
- **Dual-Dimension Audit (Pre: Flow/Logic, Post: Token/Session Results)** → runtime verification gate
...
- **Superior Quality Audit**: For auth-critical flows, apply the runtime verification gate to verify against [Superior Quality Bar](runtime verification criteria).
...
- "Use the runtime verification gate to audit this auth implementation for zero-token-leak idealism."
