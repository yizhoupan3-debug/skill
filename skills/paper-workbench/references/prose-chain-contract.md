...
| 同上 | `ROUTER_RS_CLAUDE_PAPER_PROSE_HOOK` [legacy: CODEX] | Claude / Legacy Codex CLI `UserPromptSubmit` |
| `configs/framework/PAPER_ADVERSARIAL_HOOK.txt` | `ROUTER_RS_*_PAPER_ADVERSARIAL_HOOK=1`（五宿主对称；**默认关**） | 同上 |
