...
- **框架连续性目录**：[`artifacts/current/`](../../../artifacts/current/) 下的 `SESSION_SUMMARY` / `NEXT_ACTIONS` / `EVIDENCE_INDEX`（及同层相关指针）是跨会话接力的机器可读真源；分层与开关以 docs/adr/010-ideal-architecture-v10.md](../../../docs/adr/010-ideal-architecture-v10.md) 为准。
