...
- Then run `cargo run --manifest-path /Users/joe/Developer/skill/rust_tools/image_gen_rs/Cargo.toml -- generate --prompt "Test" --dry-run` to confirm the request shape.
