...
This skill owns **data acquisition, validation, normalization, and export only**. It must **not** own any task that decides strategy, alpha, execution, or risk. If the task includes any of those decisions, start with [`algo-trading`](../../SKILL.md) and use this skill only as a supporting data tool.
...
Use: `${SKILL_FRAMEWORK_ROOT}/skills/algo-trading/SKILL.md`
