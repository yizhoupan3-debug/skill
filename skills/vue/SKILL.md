...
- **Dual-Dimension Audit (Pre: Reactivity/Spec, Post: Hydration/Component Results)** → runtime verification gate
...
- **Superior Quality Audit**: For complex reactivity or Nuxt routes, apply the runtime verification gate to verify against [Superior Quality Bar](runtime verification criteria).
...
- "Use the runtime verification gate to audit this Vue/Nuxt implementation for result idealism."
