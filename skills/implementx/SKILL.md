...
| Subagent 不能 spawn subagent | 单层 delegation（对齐 Claude Code 官方 subagent 规范） |
...
**subagent 不直接相互通信**（对齐 Claude Code 官方规范）；所有跨 lane 信息经 coordinator 中转。
