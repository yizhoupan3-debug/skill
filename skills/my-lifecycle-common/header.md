# My Lifecycle 共享 Header (HARD)

**适用于**: discussx / planx / implementx / verifyx 4 个 my-lifecycle skill。
...
> 完整契约见 `../my-lifecycle-common/GOAL_STATE_CONTRACT.md`。

3 个 skill（discussx / planx / implementx）的 `### GOAL_STATE writes` 段统一引用本节，不重复实现。verifyx 不写 GOAL_STATE（仅 consume + complete）。
