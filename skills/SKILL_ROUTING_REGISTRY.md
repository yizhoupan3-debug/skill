...
| `security-audit` | Active | P2 | L4 | overlay | none | project | ✓ 96.8 | Audit implementation-level security defects in auth, injection, SSRF, CSRF, secr |
| `security-threat-model` | Active | P2 | L3 | owner | none | project | ✓ 90.7 | Repository-grounded threat modeling for applications, services, MCP servers, API |
