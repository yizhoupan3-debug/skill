...
- The task is code comment style enforcement only -> use the current code review or implementation context
- The task is API interface design (not its documentation) -> use the current implementation context
