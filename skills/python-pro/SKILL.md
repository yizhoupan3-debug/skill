...
- **Dual-Dimension Audit (Pre: Pyproject-Config/Typing, Post: Package-Integrity/Perf-Metric Results)** → runtime verification gate
...
- **Superior Quality Audit**: For production-grade Python services, apply the runtime verification gate to verify against [Superior Quality Bar](runtime verification criteria).
...
- "Use the runtime verification gate to audit this Python service for performance-metric idealism."
