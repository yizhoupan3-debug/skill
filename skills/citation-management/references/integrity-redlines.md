...
与 [`../SKILL.md`](../SKILL.md) 的 Truth Rules 叠加；涉及 **数据造假、剽窃、不可核验主张** 时，审稿侧按 `$paper-reviewer` **P0 一票否决**处理（见 [`../../paper-workbench/references/severity-spec.md`](../../paper-workbench/references/severity-spec.md)）。
