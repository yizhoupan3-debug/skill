...
- **Dual-Dimension Audit (Pre: Logic/Patterns, Post: Consistency/State Results)** → `$execution-audit-codex` [Overlay]
...
- **Superior Quality Audit**: For system-critical data flows, trigger `$execution-audit-codex` to verify against [Superior Quality Bar](../execution-audit-codex/references/superior-quality-bar.md).
...
- "Use $execution-audit-codex to audit this datastore design for consistency-state idealism."
