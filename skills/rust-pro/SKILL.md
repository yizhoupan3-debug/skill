...
- Rust-specific safety, borrowing, and macro issues are owned by this skill.
- **Dual-Dimension Audit (Pre: Cargo-Toml/Feat-Logic, Post: Build-Artifact/Binary-Size Results)** → `$execution-audit-codex` [Overlay]
...
- "Use $execution-audit-codex to audit this Rust project for binary-size idealism."
