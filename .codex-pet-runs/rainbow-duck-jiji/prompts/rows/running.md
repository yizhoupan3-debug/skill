Create a single horizontal sprite strip for the Codex app digital pet `rainbow-duck-jiji` in the state `running`.
...
Motion readability repair: make the run clearly readable at 192x208. Across the 6 frames, show a lively in-place run: alternating feet far forward/back, slippers visibly swinging, body bobbing with squash/stretch, wings counter-swinging, bill and head bobbing, and the nightcap pom bouncing. Use distinct cycle phases, not near-identical standing poses. Keep every pose complete and inside its slot.

Rock Kingdom mobile action redesign: make this a frantic in-place "pa-da pa-da" Duck Jiji shuffle. The body should pump up and down like a bouncy pear, slippers should alternate wide apart with one lifted high, wings should pop out as counterweights, and the nightcap should lag behind the motion like a soft tail. Prioritize readable silhouette changes over tiny markings.

Final polish directive, superseding any earlier exaggeration: make this a smooth in-place work-energy shuffle, not a size-changing bounce. Keep body scale stable; show rhythm through alternating slippers, small wing counter-swing, bill bob, and hat-pom follow-through. Keep height/width changes subtle and make frame 5 loop cleanly to frame 0.
