Create a single horizontal sprite strip for the Codex app digital pet `rainbow-duck-jiji` in the state `jumping`.
...
Motion readability repair: make the jump clearly readable at 192x208. Across the 5 frames, show a strong crouch/squash, lift-off with legs tucked, high peak with body stretched upward, descent, and squashed landing recovery. Move the whole pet vertically inside each slot while keeping safe padding. Do not add shadows, dust, impact marks, or floor cues.

Rock Kingdom mobile action redesign: make this a plush, toy-like Duck Jiji hop. The round body should flatten low before takeoff, stretch tall at the peak, tuck slippers under the belly midair, spread wings for balance, and let the nightcap pom lag behind then flop down. The vertical pose change must be obvious without shadows or floor marks.

Final polish directive, superseding any earlier exaggeration: this is a small buoyant hop, not a scale-change transformation. Keep the duck's body mass consistent; use vertical position and tucked feet to show jump, with only mild squash/stretch. The top of the hat may move upward, but the body should not become dramatically taller or shorter. Frame 4 must land close to frame 0 for a smooth loop.
