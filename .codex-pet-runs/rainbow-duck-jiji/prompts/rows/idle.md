Create a single horizontal sprite strip for the Codex app digital pet `rainbow-duck-jiji` in the state `idle`.
...
Motion readability repair: make the loop visibly animated at 192x208. Across the 6 frames, show a clear sleepy breath cycle with body squash/stretch, head and bill bobbing up and down, eyelids changing from relaxed open slits to closed and back, tiny feet shifting weight, and the nightcap pom bouncing. Use distinct poses, not near-identical copies. Keep motion inside each slot and preserve identity.

Rock Kingdom mobile action redesign: use a playful "wake-up duck" rhythm inspired by Duck Jiji's round body and sleepy cap. The silhouette should change clearly frame to frame: droopy compressed body -> puffed tall inhale -> sleepy head dip -> little startled wake-up lift -> hat pom overshoots -> settles. Make the bill, eyelids, wings, slippers, and cap all follow the body bounce with delayed secondary motion.

Final polish directive, superseding any earlier exaggeration: keep the pet's apparent body size stable and natural. No frame may look like a different scale. Keep the body center within a small smooth path, keep head-and-hat height within about 8% of neighboring frames, and use only mild squash/stretch. Make frame 5 transition smoothly back to frame 0. The animation should feel like a soft sleepy breathing loop, not a size pop.
